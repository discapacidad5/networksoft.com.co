			...
			<div class="catItemImageBlock">
				<span class="catItemImage">
					<a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
						<img src="<?php echo $this->item->image; ?>" class="img-responsive" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" />
					</a>
				</span>
			...
			<?php if(
				...
				<div class="catItemLinks">
					...
					<?php if($this->item->params->get('catItemAuthor')): ?>
						<!-- Item Author -->
						<div class="catItemAuthor pull-left">
					...
					<?php if($this->item->params->get('catItemHits')): ?>
						...
						<div class="catItemHitsBlock pull-right">
							<span class="catItemHits">
								<i class="fa fa-heart">&nbsp;</i> <?php echo $this->item->hits; ?> <?php echo JText::_('K2_TIMES'); ?>
							</span>
						</div>
					<?php endif; ?>
					<?php if($this->item->params->get('catItemRating')): ?>
						<!-- Item Rating -->
						<div class="catItemRatingBlock pull-right">
							<span>rate this</span>
	...
	<div class="agnes-k2-footer">
				...
				<?php else: ?>
					<?php if($this->item->numOfComments > 0): ?>
						<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
                            <i class="fa fa-comments-o"> </i> <?php echo $this->item->numOfComments; ?> <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?>
						</a>
					<?php else: ?>
						<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
							<i class="fa fa-comments-o"> </i> <?php echo JText::_('0 Comment'); ?>
						</a>
					<?php endif; ?>
				<?php endif; ?>
			</div>
		...
		<?php if ($this->item->params->get('catItemReadMore')): ?>
			...
			<div class="catItemReadMore pull-right">
				<a class="btn k2ReadMore" href="<?php echo $this->item->link; ?>">
