			...
			<div class="eb-nav-collapse">
				<ul class="blog-navi <?php echo $system->config->get( 'layout_iconless' ) ? ' iconless' : '';?> reset-ul float-li clearfix">
					...
					<li class="toolbar-item toolbar-latest <?php echo $views->home;?>">
						<a href="<?php echo EasyBlogRouter::_('index.php?option=com_easyblog'); ?>"><span><i class="fa fa-home"></i></span></a>
						<div class="tips">
							<i></i>
					...
					<li class="toolbar-item toolbar-categories <?php echo $views->categories;?>">
						<a href="<?php echo EasyBlogRouter::_('index.php?option=com_easyblog&view=categories'); ?>"><span><i class="fa fa-folder"></i></span></a>
						<div class="tips">
							<i></i>
					...
					<li class="toolbar-item toolbar-tags <?php echo $views->tags;?>">
						<a href="<?php echo EasyBlogRouter::_('index.php?option=com_easyblog&view=tags'); ?>"><span><i class="fa fa-tag"></i></span></a>
						<div class="tips">
							<i></i>
					...
					<?php if($isBloggerMode === false) : ?>
						...
						<li class="toolbar-item toolbar-blogger <?php echo $views->blogger;?>">
							<a href="<?php echo EasyBlogRouter::_('index.php?option=com_easyblog&view=blogger'); ?>"><span><i class="fa fa-user"></i></span></a>
							<div class="tips">
								<i></i>
						...
						<li class="toolbar-item toolbar-teamblog <?php echo $views->teamblog;?>">
							<a href="<?php echo EasyBlogRouter::_('index.php?option=com_easyblog&view=teamblog'); ?>"><span><i class="fa fa-users"></i></span></a>
							<div class="tips">
								<i></i>
					...
					<li class="toolbar-item toolbar-archive <?php echo $views->archive;?>">
						<a href="<?php echo EasyBlogRouter::_('index.php?option=com_easyblog&view=archive'); ?>"><span><i class="fa fa-calendar"></i></span></a>
						<div class="tips">
							<i></i>
					...
					<li class="toolbar-item user-access float-r">
						<a href="javascript:void(0);" onclick="eblog.login.toggle()"><span><i class="fa fa-lock"></i></span></a>
						<div class="tips">
							<i></i>
