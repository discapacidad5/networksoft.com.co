					...
					<h3 class="featured-title rip"><a href="<?php echo EasyBlogRouter::_( 'index.php?option=com_easyblog&view=entry&id=' . $row->id );?>"><?php echo $row->title;?></a></h3>
						...
						<div class="featured-author">
							...
							<div class="showcase-author">
								<?php echo JText::_('COM_EASYBLOG_BY'); ?> <a href="<?php echo $row->author->getProfileLink(); ?>"><?php echo $row->author->getName(); ?></a>
								<div class="create-date"><?php echo $this->formatDate( $system->config->get('layout_dateformat') , $row->created ); ?></div>
							</div>
